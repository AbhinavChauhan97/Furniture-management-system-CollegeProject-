...
public class FilterPanel extends JPanel{
	...
	final RecordsPanel tableInView;
	...
	public FilterPanel(final String tableName,final RecordsPanel tableInView,String[] columns)
	{   
		setupFilters();
		this.tableName = tableName;
		this.tableInView = tableInView;
	...
	public JButton filterButton()
	{
		...
		filterButton.addActionListener(e -> {
			                                 this.tableInView.remove(this.tableInView.recordsTable);
			                                 this.tableInView.recordsTable = new RecordsTable(Database.getFilteredRecords
                                                      (this.selectedDay,this.selectedMonth,this.selectedYear,this.tableName),this.columns);
			                                 this.tableInView.add(this.tableInView.recordsTable);
			                                 }
		                              );
		return filterButton;
	}
